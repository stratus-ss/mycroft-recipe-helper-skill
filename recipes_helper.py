...
def convert_ml_to_litres(number_of_ml):
    number_of_litres = number_of_ml * 1000
    return number_of_litres

def convert_cups_to_ml(number_of_cups):
    number_of_ml = number_of_cups / cups_ml_constant_number
    return number_of_ml

def convert_cups_to_litres(number_of_cups):
    number_of_litres = number_of_cups / cups_litres_constant_number
    return number_of_litres

def convert_ml_to_cups(number_of_ml):
    number_of_cups = number_of_ml * cups_ml_constant_number
    return number_of_cups

def convert_litres_to_cups(number_of_litres):
    number_of_cups = number_of_litres * cups_litres_constant_number
    return number_of_cups

def convert_pints_to_ml(number_of_pints):
    number_of_ml = number_of_pints / pints_ml_constant_number
    return number_of_ml

def convert_pints_to_litres(number_of_pints):
    number_of_litres = number_of_pints / pints_litres_constant_number
    return number_of_litres

def convert_ml_to_pints(number_of_ml):
    number_of_pints = number_of_ml * pints_ml_constant_number
    return number_of_pints

def convert_litres_to_pints(number_of_litres):
    number_of_pints = number_of_litres * pints_litres_constant_number
    return number_of_pints

def convert_fl_oz_to_ml(number_of_fl_oz):
    number_of_ml = number_of_fl_oz / fl_oz_ml_constant_number
    return number_of_ml

def convert_fl_oz_to_litres(number_of_fl_oz):
    number_of_litres = number_of_fl_oz / fl_oz_litres_constant_number
    return number_of_litres

def convert_ml_to_fl_oz(number_of_ml):
    number_of_fl_oz = number_of_ml * fl_oz_ml_constant_number
    return number_of_fl_oz

def convert_litres_to_fl_oz(number_of_litres):
    number_of_fl_oz = number_of_litres * fl_oz_litres_constant_number
    return number_of_fl_oz

def convert_oz_to_grams(number_of_oz):
    number_of_grams = number_of_oz / grams_oz_constant_number
    return number_of_grams

def convert_lbs_to_grams(number_of_lbs):
    number_of_grams = number_of_lbs / grams_lbs_constant_number
    return number_of_grams

def convert_grams_to_oz(number_of_grams):
    number_of_oz = number_of_grams * grams_oz_constant_number
    return number_of_oz

def convert_grams_to_lbs(number_of_grams):
    number_of_lbs = number_of_grams * grams_lbs_constant_number
